...
public class GameSetting : SingletonNew< GameSetting > 
{
	...
	[ HideInInspector ]
	public bool enablePlayerName = true;
	[ HideInInspector ]
	public bool enableTime = true;
	[ HideInInspector ]
	public bool enableDoubleF = false;
	[ HideInInspector ]
	public bool enableDoubleF1 = false;
	...
	public void save()
	{
		...
		PlayerPrefs.SetInt( "enablePlayerName" , enablePlayerName ? 1 : 0 );
		PlayerPrefs.SetInt( "enableTime" , enableTime ? 1 : 0 );
		PlayerPrefs.SetInt( "enableDoubleF" , enableDoubleF ? 1 : 0 );
	...
	public void load()
	{
		...
		enableSound = PlayerPrefs.GetInt( "enableSound" , 1 ) > 0 ? true : false;
		enablePlayerName = PlayerPrefs.GetInt( "enablePlayerName" , 0 ) > 0 ? true : false;
		enableTime = PlayerPrefs.GetInt( "enableTime" , 0 ) > 0 ? true : false;
		enableDoubleF = PlayerPrefs.GetInt( "enableDoubleF" , 0 ) > 0 ? true : false;

		enableDoubleF1 = enableDoubleF;
